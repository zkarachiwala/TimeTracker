...
namespace TimeTracker.Web.Migrations
{
    ...
    [Migration("20260902121112_AddTimeEntryClientRequestId")]
    partial class AddTimeEntryClientRequestId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("seq_ClientRef", "app");

            modelBuilder.HasSequence<int>("seq_ProjectRef", "app");
            ...
            modelBuilder.Entity("TimeTracker.Shared.Entities.Client", b =>
                {
                    ...
                    b.Property<string>("RefCode")
                        ...
                        .HasComputedColumnSql("'CLI-' + RIGHT('000' + CAST(ClientSeqId AS VARCHAR(10)), 3)", true);
            ...
            modelBuilder.Entity("TimeTracker.Shared.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("RefCode")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComputedColumnSql("'PROJ-' + RIGHT('000' + CAST(ProjectSeqId AS VARCHAR(10)), 3)", true);
