...
- This plan file was independently created on the #337, #338, and #341 branches (each branched from `main` before the others merged). #375 merged first and caused conflicts on both #376 and #378, both resolved by merging `main` back in. No further conflicts expected once #376 also merges — #378 already carries the merge.
